...
const ExchangeOnlineGuide: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <RecoveringMailboxSection title={'Recover'}>
        <div />
      </RecoveringMailboxSection>
      <ExportFutureInvitationsSection title={'Find'} >
        <div />
      </ExportFutureInvitationsSection>
      <SendCancellationsSection title={'Cancel'}>
        <div />
      </SendCancellationsSection>
    </div>
  );
};
